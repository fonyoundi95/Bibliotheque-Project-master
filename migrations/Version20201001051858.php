 ...
 */
final class Version20201001051858 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE books ADD category_id INT NOT NULL, ADD author_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE books DROP category_id, DROP author_id');
    }
}
